        ...
        <div>
          <div className="row">
            <div className="how-to-create-team">
              There are three main steps to associating a project or interest to
              an IoT (device or hub). They are:
              <ul>
                <li>
                  Step 1 :: You must have an aspect-of-interest (e.g. workplace,
                  vehicle, home, items etc.) that has attached IoT devices. These
                  IoT devices are available/connected to the internet.
                  {"Internet of Things "}
                </li>
                <li>
                  Step 2 :: The IoT device must be available in the
                  cloud (e.g. AWS IoT, Azure, Google, IBM, and
                  others including micro-IoT Server like via Raspberry Pi
                  enabled) and be available as an API.
                </li>
                <p>
                  <font color="lightblue" size="3">
                    <i>
                      An addendum of step 2 would be to setup association with a
                      Rule-Engine to enable IFTTT (If this then that) scenarios. This
                      can be done in most available cloud-platforms (mentioned
                      above). You can create your own in a local hub (e.g. via Raspberry
                ...
                <li>
                  Step 3 :: Once the above steps are done and if those robotized POIs
                  (point of interest) have any relevance (authorized and
                  available as services) to the project then the
                  project-team/manager should make an association between the POI and
              ...
              <ul>
                <li>
                  Provide a name for the IoT association that will be used
                  as a reference.
                </li>
                <li>
                ...
                <li>
                  Select an option of available IoT services that are ready
                  to be associated by the project.
                </li>
              </ul>
              <p>
                NOTE: IoT based project management is very new. The
                assumption is that the project target is IoT (sensor - actuator)
                enabled to make the point-of-interest smart. That is, the
                project manager can now maneuver the project,
                get intelligence, remotely control in real time thereby enabling distributed
                cooperation. This data can also emulate artificial
                intelligence to make project management much more efficient than
                legacy manual processes. All these steps are outside the scope of this
                UX.
              </p>
              <p>
                Baanda will have a separate consulting wing to enable IoT
        ...
        <div>
          ...
          <div className="row">
            <div className="col-md-6">
              <TextFieldGroup
                name="iotsetupname"
                placeholder="Enter an IoT name to associate with"
              ...
              <div className="justify-content-md-left">
                <font color="blue">
                  <Select
                    ...
                    maxMenuHeight={150}
                    isSearchable={true}
                    placeholder="Select reference IoT name to edit"
                  />
                </font>
              </div>
            </div>
