            ...
            <div className="mx-auto text-center">
              <div className="card card-body bg-dark text_white">
                <h5 className="card-title">
                  <strong>
                    <font color="red">Select Profile Handling Type Please</font>
                  </strong>
                </h5>
                <p className="card-test">
                  Please select the profile type for the the right input-form
                </p>
                <p className="card-test">
                  Basic Profile must be completed before using Baanda.
                </p>
                <p className="card-test">
